# -*- coding: utf-8 -*-
"""SC_CNN_CIFAR_grayscale.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1P4qU8R0NwJZbcO3QjvxHq5KWGoeJwAHU
"""
...
def unet_model(input_size=(28, 28, 1), n_filters_start=32, growth_factor=2,
    ...
    if is_grayscale:
        ...
        model.compile(optimizer=Adam(lr=0.001), loss=[built_in_softmax_kl_loss, intensity_softmax_loss], metrics=['accuracy', 'categorical_accuracy'])
    else:
        ...
        model.compile(optimizer=Adam(lr=0.001), loss=[built_in_softmax_kl_loss, intensity_softmax_loss], metrics=['accuracy'])
...
model_custom_name = 'nade-cifar-grayscale-double-softmax'
model_full_name = '{}-num-samples-{}-noise-upper-{}-{}'.format(model_custom_name, num_samples, noise_upper_bound, is_single_text)
model_location = '/opt/program/checkpoints/{}.hdf5'.format(model_full_name)
log_dir = '/opt/program/logs/{}'.format(model_full_name)
...
evaluate_callback = EvaluateCallback(image_shape, os.path.join(log_dir, 'cifar-grayscale-1'))
